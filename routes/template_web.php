...
Route::group(['middleware' => $middlewares],
        function () use ($legoConfig) {
            ...
            Route::get('/home',
                    [Zevitagem\LaravelSaasTemplateCore\Http\Controllers\Pages\HomeController::class, 'index'])->name('home.index');
            ...
            Route::prefix('/config')->group(function () use ($legoConfig) {
                ...
                Route::get('/dashboard',
                        [Zevitagem\LaravelSaasTemplateCore\Http\Controllers\Pages\Config\DashboardConfigController::class, 'index'])->name('dashboard_config.index');
                Route::get('/data',
                        [Zevitagem\LaravelSaasTemplateCore\Http\Controllers\Pages\Config\DataConfigController::class, 'index'])->name('data_config.index');
                ...
                Route::resource('user_config',
                        Zevitagem\LaravelSaasTemplateCore\Http\Controllers\Pages\Config\UserConfigController::class)->only([
                    'index', 'show', 'update', 'store'
